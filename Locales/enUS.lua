...
L["Option.UnitReactionType.xOffset.Desc"]         =
"The x offset of the texture relative to the anchor point. Negative values move the texture left, positive values move the texture right."

L["Option.UnitReactionType.yOffset.Name"]         = "Y Offset"
L["Option.UnitReactionType.yOffset.Desc"]         =
"The y offset of the texture relative to the anchor point. Negative values move the texture down, positive values move the texture up."
