...
TARGET_CONFIG.SELF.ENABLED = true

TARGET_CONFIG.FRIENDLY.ENABLED = true

TARGET_CONFIG.HOSTILE.ENABLED = true
...
TARGET_CONFIG.SELF.TEXTURE_PATH = "Interface\\AddOns\\TargetNameplateIndicator\\Textures\\Reticule"

TARGET_CONFIG.FRIENDLY.TEXTURE_PATH = "Interface\\AddOns\\TargetNameplateIndicator\\Textures\\Reticule"

TARGET_CONFIG.HOSTILE.TEXTURE_PATH  = "Interface\\AddOns\\TargetNameplateIndicator\\Textures\\Reticule"
...
TARGET_CONFIG.SELF.TEXTURE_HEIGHT = 50
TARGET_CONFIG.SELF.TEXTURE_WIDTH  = 50

TARGET_CONFIG.FRIENDLY.TEXTURE_HEIGHT = 50
...
TARGET_CONFIG.FRIENDLY.OFFSET_Y = 5
...
TARGET_CONFIG.HOSTILE.OFFSET_Y = 5
