...
-------
MOUSEOVER_CONFIG.ENABLED = true

-------
-- These variables control whether the indicator is visible for yourself and for friendly and hostile units.
-------

MOUSEOVER_CONFIG.SELF.ENABLED = true

MOUSEOVER_CONFIG.FRIENDLY.ENABLED = true

MOUSEOVER_CONFIG.HOSTILE.ENABLED = true
...
MOUSEOVER_CONFIG.SELF.TEXTURE_PATH = "Interface\\AddOns\\TargetNameplateIndicator\\Textures\\Reticule"

MOUSEOVER_CONFIG.FRIENDLY.TEXTURE_PATH = "Interface\\AddOns\\TargetNameplateIndicator\\Textures\\Reticule"

MOUSEOVER_CONFIG.HOSTILE.TEXTURE_PATH  = "Interface\\AddOns\\TargetNameplateIndicator\\Textures\\Reticule"
...
MOUSEOVER_CONFIG.SELF.TEXTURE_HEIGHT = 50
MOUSEOVER_CONFIG.SELF.TEXTURE_WIDTH  = 50

MOUSEOVER_CONFIG.FRIENDLY.TEXTURE_HEIGHT = 50
...
MOUSEOVER_CONFIG.SELF.OFFSET_Y = 5
...
MOUSEOVER_CONFIG.FRIENDLY.OFFSET_Y = 5
...
MOUSEOVER_CONFIG.HOSTILE.OFFSET_Y = 5
